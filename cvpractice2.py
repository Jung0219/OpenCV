...
plt.subplot(141);plt.imshow(imgRGB);plt.title("original")
plt.subplot(142);plt.imshow(cv2.flip(imgRGB, 0));plt.title("vertical flip")
plt.subplot(143);plt.imshow(cv2.flip(imgRGB, 1));plt.title("horizontal flip")
plt.subplot(144);plt.imshow(cv2.flip(imgRGB, -1));plt.title("both flip")
